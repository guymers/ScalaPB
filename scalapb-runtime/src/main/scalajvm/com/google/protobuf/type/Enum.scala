...
object Enum extends scalapb.GeneratedMessageCompanion[com.google.protobuf.`type`.Enum] with scalapb.JavaProtoSupport[com.google.protobuf.`type`.Enum, com.google.protobuf.Enum] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.google.protobuf.`type`.Enum = {
    var __name: _root_.scala.Predef.String = ""
    val __enumvalue: _root_.scala.collection.immutable.VectorBuilder[com.google.protobuf.`type`.EnumValue] = new _root_.scala.collection.immutable.VectorBuilder[com.google.protobuf.`type`.EnumValue]
